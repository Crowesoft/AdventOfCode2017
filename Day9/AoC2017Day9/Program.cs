namespace Day9
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var path = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location)?.Replace("\\AoC2017Day9\\bin\\Debug", string.Empty);

            var answer = Parse(File.ReadAllText($"{path}\\input.txt"));
        }
